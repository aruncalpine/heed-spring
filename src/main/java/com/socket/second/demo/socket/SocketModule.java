package com.socket.second.demo.socket;
...
import com.socket.second.demo.service.SocketService;
  ...
  HashMap<String,UUID> map2=new HashMap<String,UUID>();
    ...
    private ConnectListener onConnected() {
        ...
        //   client.joinRoom(room);
        	 ...
        	 System.out.println("Socket ID[{}]  Connected to socket   "+ client.getSessionId().toString()+"         " + client.getRemoteAddress()+ "   "+ client.getNamespace());
        };
